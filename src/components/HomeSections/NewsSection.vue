...
<template>
  ...
  <div
    ...
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
      <h2 class="text-2xl text-indigo-800 font-bold md:text-3xl md:leading-tight dark:text-white">News</h2>
      <p class="mt-1 text-slate-800 text-lg dark:text-slate-300">See how game-changing companies are making the most of every engagement with
        Preline.</p>
    </div>
    <!-- End Title -->
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <!-- Card -->
      <a
          class="group flex flex-col h-full border mx-1 hover:border-transparent hover:shadow-xl transition-all duration-300 rounded-xl p-5 dark:border-slate-600 dark:bg-slate-900 dark:hover:shadow-black/[.4]" href="#">
