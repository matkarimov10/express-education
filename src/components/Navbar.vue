...
<template>
  <nav class="sticky top-0 z-20 w-full bg-white bg-opacity-50 border-b backdrop-filter backdrop-blur-lg dark:border-slate-600 dark:bg-slate-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl py-1 mx-auto mb-1">
      ...
      <div class="flex items-center mx-3 md:order-2">
<!--        Language Dropdown-->
        <div @click="useDropDownStore().openLanguageDropDown()"
             class="flex items-center px-2 py-3 space-x-1 text-base leading-none transition duration-200 bg-transparent border-0 rounded-full cursor-pointer text-slate-800 dark:text-slate-300 hover:text-black dark:hover:text-white">
        ...
        <button class="flex flex-col items-center md:flex-row">
